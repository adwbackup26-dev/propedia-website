...
export default async function handler(req, res) {
  ...
  const select = [
    ...
    'YearBuilt',
    'ParkingTotal',
    'LivingAreaRange', 'AboveGradeFinishedArea', 'BelowGradeFinishedArea',
    'ApproximateSquareFootage',
    'ListDate', 'OriginalEntryTimestamp', 'CloseDate',
    'DaysOnMarket', 'DaysOnMarketCumulative', 'ModificationTimestamp',
